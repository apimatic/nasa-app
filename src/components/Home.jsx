      ...
      <div className={styles.homeContent}>
        ...
        <Container className={styles.aboutContent}>
          ...
          <p className={styles.disclaimer}>
            {" "}
            *We promise not to send you any emails outside this demo
          </p>
          ...
          <p className={styles.info}>
            {" "}
            It may take a couple of minutes to fetch a high resolution image
            from NASA
          </p>

          <p className={styles.description}>
            This app is built using APIMatic's auto-generated SDKs for the NASA
            and SendGrid APIs.
          </p>
        </Container>
      </div>
